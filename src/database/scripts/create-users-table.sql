...
('admin', '$2b$12$hewfKDJ.ePQlstn.wswV.u4/P0t7bmkXsBnKfVtwm8eqwGYYANPPi', 'admin@example.com', '管理员');

-- 插入普通用户
-- 密码: user123
INSERT IGNORE INTO `users` (`username`, `password`, `email`, `nickname`) VALUES
('user', '$2b$12$OHLOwNUNxVvwTaU5I81gau0U0An9cJZoHJ1kB6AzFkiQ4nnpnjkcK', 'user@example.com', '普通用户');

-- 插入测试用户  
-- 密码: test123
INSERT IGNORE INTO `users` (`username`, `password`, `email`, `nickname`) VALUES
('test', '$2b$12$WIXTuIzTzW1phYHCM2UKdu/06rzTX0j82O/xYWBGjc4ptz20/vPLC', 'test@example.com', '测试用户');
